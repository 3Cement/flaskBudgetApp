...
from budgetApp.forms import LoginForm, RegistrationForm
    ...
    transactions = [
        {
            ...
            'transaction_name': 'Wydatek 1'
        },
        {
            'author': {'username': 'Susan'},
            'transaction_name': 'Przychód 3'
        }
    ]
...
def user(username):
    ...
    transactions = [
        {'author': user, 'name': 'Test post #1', 'price': 123},
        {'author': user, 'name': 'Test post #2', 'price': '111'}
    ]
